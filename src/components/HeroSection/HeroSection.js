    ...
    <>
      <div className='heroSection'>
        <div className='hero-content'>
            <h1>Hey, I’m Marko Lukesevik and I love building beautiful websites</h1>
      ...
      <div className='heroSection-small'></div>
        <h1 className='hero-content-small'>Hey, I’m Marko Lukesevik and I love building beautiful websites</h1>
